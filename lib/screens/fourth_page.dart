  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          'Student Projects',
          style: TextStyles.baseSemiboldStyle.copyWith(color: AppColors.darkTextColor),
        ),
        ...
        itemBuilder: (context, count) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border(bottom: BorderSide(color: AppColors.greyLight, width: 2))
            ),
            child: Column(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        current.name,
                        style: TextStyles.baseBoldStyle.copyWith(
                          color: AppColors.darkTextColor),
                      ),
                      SizedBox(height: 7,),
                      Text(
                        current.authorName,
                        style: TextStyles.baseStyle.copyWith(color: AppColors.darkTextColor),
                      ),
                    ],
                  ),
                ),
